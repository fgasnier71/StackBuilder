        ...
        : TreeView, IDocumentListener
    {
        ...
        public AnalysisTreeView()
        {
            try
            {
                ...
                ImageList.Images.Add(Pack);                        // 6
                ImageList.Images.Add(Bag);                         // 7
                ImageList.Images.Add(Cylinder);                    // 8
                ImageList.Images.Add(Bottle);                      // 9
                ImageList.Images.Add(Pallet);                      // 10
                ImageList.Images.Add(Truck);                       // 11
                ImageList.Images.Add(Interlayer);                  // 12
                ImageList.Images.Add(PalletCorners);               // 13
                ImageList.Images.Add(PalletCap);                   // 14
                ImageList.Images.Add(PalletFilm);                  // 15
                ImageList.Images.Add(PalletLabel);                 // 16     
                ImageList.Images.Add(AnalysisCasePallet);          // 17
                ImageList.Images.Add(AnalysisBundlePallet);        // 18
                ImageList.Images.Add(AnalysisPackPallet);          // 19
                ImageList.Images.Add(AnalysisCase);                // 20
                ImageList.Images.Add(AnalysisCylinderPallet);      // 21
                ImageList.Images.Add(AnalysisHCylinderPallet);     // 22
                ImageList.Images.Add(AnalysisTruck);               // 23
        ...
        private int ToIconIndex(NodeTag.NodeType nodeType)
        {
            switch (nodeType)
            {
                case NodeTag.NodeType.NT_BOX: return 3;
                case NodeTag.NodeType.NT_CASE: return 4; 
                case NodeTag.NodeType.NT_BUNDLE: return 5;
                case NodeTag.NodeType.NT_PACK: return 6;
                case NodeTag.NodeType.NT_BAG: return 7;
                case NodeTag.NodeType.NT_CYLINDER: return 8;
                case NodeTag.NodeType.NT_BOTTLE: return 9;
                case NodeTag.NodeType.NT_PALLET: return 10;
                case NodeTag.NodeType.NT_TRUCK: return 11;
                case NodeTag.NodeType.NT_INTERLAYER: return 12;
                case NodeTag.NodeType.NT_PALLETCORNERS: return 13;
                case NodeTag.NodeType.NT_PALLETCAP: return 14;
                case NodeTag.NodeType.NT_PALLETFILM: return 15;
                case NodeTag.NodeType.NT_PALLETLABEL: return 16;
                default: return 2;
            }
        }
        ...
        private int ToIconIndex(ItemBase item)
        {
            if (item is AnalysisCasePallet)
            {
                ...
                if (content is BoxProperties || content is BagProperties || content is LoadedCase) return 17;
                else if (content is BundleProperties) return 18;
                else if (content is PackProperties) return 19;
                else return 0;
            }
            else if (item is HAnalysisPallet) return 17;
            else if (item is AnalysisBoxCase) return 20;
            else if (item is AnalysisCylinderCase) return 20;
            else if (item is AnalysisCylinderPallet) return 21;
            else if (item is AnalysisHCylPallet) return 21;
            else if (item is AnalysisCaseTruck) return 23;
            else if (item is AnalysisCylinderTruck) return 23;
            else if (item is AnalysisHCylTruck) return 23;
            else if (item is AnalysisPalletTruck) return 23;
        ...
        public void OnNewTypeCreated(Document doc, ItemBase itemProperties)
        {
            ...
            if (itemProperties.GetType() == typeof(CaseOfBoxesProperties))
            {
                ...
                iconIndex = ToIconIndex(NodeTag.NodeType.NT_CASEOFBOXES);
            ...
            else if (itemProperties.GetType() == typeof(BoxProperties))
            {
                ...
                if (boxProperties.HasInsideDimensions)
                {
                    ...
                    iconIndex = ToIconIndex(NodeTag.NodeType.NT_CASE);
                    parentNodeType = NodeTag.NodeType.NT_LISTCASE;
                }
                else
                {                    
                    nodeType = NodeTag.NodeType.NT_BOX;
                    iconIndex = ToIconIndex(NodeTag.NodeType.NT_BOX);
            ...
            else if (itemProperties.GetType() == typeof(BagProperties))
            {
                ...
                iconIndex = ToIconIndex(NodeTag.NodeType.NT_BAG);
                parentNodeType = NodeTag.NodeType.NT_LISTCASE;
            }
            else if (itemProperties.GetType() == typeof(BundleProperties))
            {
                nodeType = NodeTag.NodeType.NT_BUNDLE;
                iconIndex = ToIconIndex(NodeTag.NodeType.NT_BUNDLE);
            ...
            else if (itemProperties.GetType() == typeof(CylinderProperties))
            {
                ...
                iconIndex = ToIconIndex(NodeTag.NodeType.NT_CYLINDER);
            ...
            else if (itemProperties.GetType() == typeof(BottleProperties))
            {
                ...
                iconIndex = ToIconIndex(NodeTag.NodeType.NT_BOTTLE);
                parentNodeType = NodeTag.NodeType.NT_LISTCYLINDER;
            }
            else if (itemProperties.GetType() == typeof(PalletProperties))
            {
                nodeType = NodeTag.NodeType.NT_PALLET;
                iconIndex = ToIconIndex(NodeTag.NodeType.NT_PALLET);
            ...
            else if (itemProperties.GetType() == typeof(InterlayerProperties))
            {
                ...
                iconIndex = ToIconIndex(NodeTag.NodeType.NT_INTERLAYER);
            ...
            else if (itemProperties.GetType() == typeof(TruckProperties))
            {
                ...
                iconIndex = ToIconIndex(NodeTag.NodeType.NT_TRUCK);
