...
set _DeploySetParametersFile=%RootPath%treeDiM.StackBuilder.WCFAppServ.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%treeDiM.StackBuilder.WCFAppServ.zip" (
echo "%RootPath%treeDiM.StackBuilder.WCFAppServ.zip" does not exist. 
...
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%treeDiM.StackBuilder.WCFAppServ.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension
) else (
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%treeDiM.StackBuilder.WCFAppServ.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%_DeploySetParametersFile%"
)
...
:usage
echo =========================================================
if not exist "%RootPath%treeDiM.StackBuilder.WCFAppServ.deploy-readme.txt" (
...
start notepad "%RootPath%treeDiM.StackBuilder.WCFAppServ.deploy-readme.txt"
)
echo =========================================================
goto :eof
