    ...
    public class Pallet
    {
        ...
        public Face[] Faces
        {
            get
            {
                ...
                faces[0] = new Face(0, new Vector3D[] { points[3], points[0], points[4], points[7] }, "PALLET"); // AXIS_X_N
                faces[1] = new Face(0, new Vector3D[] { points[1], points[2], points[6], points[5] }, "PALLET"); // AXIS_X_P
                faces[2] = new Face(0, new Vector3D[] { points[0], points[1], points[5], points[4] }, "PALLET"); // AXIS_Y_N
                faces[3] = new Face(0, new Vector3D[] { points[2], points[3], points[7], points[6] }, "PALLET"); // AXIS_Y_P
                faces[4] = new Face(0, new Vector3D[] { points[3], points[2], points[1], points[0] }, "PALLET"); // AXIS_Z_N
                faces[5] = new Face(0, new Vector3D[] { points[4], points[5], points[6], points[7] }, "PALLET"); // AXIS_Z_P
